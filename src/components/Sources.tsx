...
export default function Sources() {
  ...
  const sources = [
    ...
    { k: 's2', url: 'https://link.springer.com/article/10.1007/s11356-025-37210-9' },
  ];

  return (
    <Section id="sources" title={t('sources.title')} subtitle={t('sources.subtitle')}>
      <div className="space-y-4 max-w-3xl mx-auto">
        {sources.map((s, i) => (
          <motion.a
            ...
            whileHover={{ x: 6 }}
            className="flex items-start gap-4 p-5 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-amber-500/40 transition-colors group"
          >
