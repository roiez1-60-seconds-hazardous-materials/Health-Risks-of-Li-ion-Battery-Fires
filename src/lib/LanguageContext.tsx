...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'layers.penTitle': { he: 'עד כמה עמוק חודר הזיהום', en: 'How Deep the Contamination Reaches' },

  // Gear anatomy
  'gear.title': { he: 'ממה עשויה חליפת המגן?', en: 'What Is the Turnout Suit Made Of?' },
  'gear.fire': { he: 'צד האש · חוץ', en: 'Fire side · outer' },
  'gear.skin': { he: 'צד הגוף · עור', en: 'Body side · skin' },
  'gear.os.mat': { he: 'בד ארמידי — נומקס®/קוולר® או PBI', en: 'Aramid fabric — Nomex®/Kevlar® or PBI' },
  'gear.os.fn': { he: 'עמיד אש, חום ושחיקה. קו ההגנה הראשון מול הלהבה.', en: 'Flame, heat & abrasion resistant. First line of defense against the flame.' },
  'gear.mb.mat': { he: 'ממברנת ePTFE על מצע בד', en: 'ePTFE membrane on a fabric backing' },
  'gear.mb.fn': { he: 'עוצרת נוזלים, כימיקלים ופתוגנים — אך "נושמת" ומשחררת אדי זיעה החוצה.', en: 'Blocks liquids, chemicals & pathogens — yet breathes, releasing sweat vapor outward.' },
  'gear.tl.mat': { he: 'בידוד באטינג/לבד תפור לבד פנים', en: 'Batting/felt insulation quilted to a face cloth' },
  'gear.tl.fn': { he: 'עיקר הבידוד התרמי. השכבה הנוגעת ישירות בעור.', en: 'The main thermal insulation. The layer in direct contact with skin.' },
  'gear.note': { he: 'שלוש השכבות יחד נותנות הגנה תרמית, מחסום נוזלים ועמידות מכנית. הזיהום שמצטבר בהן הוא בדיוק מה שהמחקר בדק.', en: 'Together the three layers provide thermal protection, a liquid barrier and mechanical durability. The contamination they collect is exactly what the study measured.' },
